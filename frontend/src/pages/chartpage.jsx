...
const initialItems = [
    {
        ...
        color: "White",
        price: 145,
        img: "https://via.placeholder.com/70x90?text=Tee",
        qty: 1,
    },
    {
        id: 2,
        ...
        color: "Red",
        price: 180,
        img: "https://via.placeholder.com/70x90?text=Shirt",
        qty: 1,
    },
    {
        id: 3,
        ...
        color: "Blue",
        price: 240,
        img: "https://via.placeholder.com/70x90?text=Jeans",
        qty: 1,
    },
];
            ...
            <main className="px-4 md:px-20 py-10">
                ...
                <div className="grid lg:grid-cols-[2fr_1fr] gap-6">
                    ...
                    <aside className="border rounded-lg p-6 space-y-4 h-fit shadow-md">
                        ...
                        {/* Checkout */}
                        <button className="w-full bg-black text-white py-3 rounded-full flex items-center justify-center gap-2 hover:bg-gray-900 transition">
                            Go to Checkout
                            <FaArrowRight />
                        </button>
                    </aside>
